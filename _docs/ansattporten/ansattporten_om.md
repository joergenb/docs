...
Ansattporten er en egen innloggingtjeneste med funksjonalitet som er tilpasset bruk som ansatt eller i andre situasjoner der det er ønskelig å opptre i et representasjonsforhold på vegne av virksomheter.
...
Disse viktigste egenskapene er som følger:
